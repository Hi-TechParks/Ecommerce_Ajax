...
class AdminItemColorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //
        return redirect()->route('item.color.show', [$product_id]);
    }
    ...
    public function show($id)
    {
        ...
        $colors = DB::table('nan_product_color')
                    ...
                    ->orderBy('nan_product_color.PRODUCT_COLOR_ID', 'DESC')
                    ->paginate(10);
        ...
        //
        return view('admin.item.item_color_list')
                            ->with('colors', $colors)
                            ->with('items', $items)
                            ->with('pre_colors', $pre_colors);
    }
