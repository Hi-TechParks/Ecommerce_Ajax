          ...
          <main class="col-md-9">
            <div class="card">
              <div class="card-body">
                ...
                <?php $__currentLoopData = $parent_offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent_offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="/admin/offer/category/<?php echo e($parent_offer->OFFER_ID); ?>" class="btn btn-primary">Refresh</a>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <!--== Data Form Start ==-->
                        <form action="<?php echo e(url('/admin/offer/category/store')); ?>" method="post" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Offer Name</label>
                            <div class="col-sm-8">
                              <?php $__currentLoopData = $parent_offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent_offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <input type="text" class="form-control" value="<?php echo e($parent_offer->OFFER_NAME); ?>" name="" disabled="disabled">

                              <input type="hidden" class="form-control" value="<?php echo e($parent_offer->OFFER_ID); ?>" name="offer_id">
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <select class="form-control" name="offer_category" required="required">
                                ...
                                <option value="<?php echo e($category->PRODUCT_CATEGORY_ID); ?>"><?php echo e($category->CATEGORY_NAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>

                              <?php if($errors->has('offer_category')): ?>
                                  <span class="error_msg">
                                    <?php echo e($errors->first('offer_category')); ?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              ...
                              <?php if($errors->has('offer_gross')): ?>
                                  <span class="error_msg">
                                    <?php echo e($errors->first('offer_gross')); ?>
              ...
              <table class="table table-hover table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo e($offer->CATEGORY_NAME); ?></td>
                    <td><?php echo e($offer->OFFER_PERCENTAGE); ?> %</td>
                    <td><?php echo e($offer->OFFER_GROSS); ?> Tk</td>
                    ...
                    <td>
                      <!-- <a href="/admin/product/item/size/edit/<?php echo e($offer->OFFER_CATEGORY_ID); ?>" class="btn btn-primary">Edit</a> -->

                      <!-- <?php if( $offer->CHD_EXIST == '1' ): ?>
                      <a href="/admin/product/item/size/edit/<?php echo e($offer->OFFER_CATEGORY_ID); ?>" class="btn btn-success">Add Child</a>
                      <?php endif; ?> -->

                      <!-- Edit Record Start -->
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModal-<?php echo e($offer->OFFER_CATEGORY_ID); ?>">
                        Edit
                      </button>

                      <!-- Modal -->
                      <div class="modal fade" id="editModal-<?php echo e($offer->OFFER_CATEGORY_ID); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <!--== Data Form Start ==-->
                            <form action="/admin/offer/category/update/<?php echo e($offer->OFFER_CATEGORY_ID); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Offer Name</label>
                                <div class="col-sm-8">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <select class="form-control" name="offer_category" required="required">
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->PRODUCT_CATEGORY_ID); ?>" <?php if( $category->PRODUCT_CATEGORY_ID == $offer->PRODUCT_CATEGORY_ID ): ?> selected <?php endif; ?>><?php echo e($category->CATEGORY_NAME); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  </select>
                              ...
                              <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Offer Gross</label>
                                <div class="col-sm-8">
                                  <input type="text" class="form-control" name="offer_gross" value="<?php echo e($offer->OFFER_GROSS); ?>" placeholder="Offer Gross">
                              ...
                              <!-- <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="child_exist" value="1" id="child_exist_<?php echo e($offer->OFFER_CATEGORY_ID); ?>" <?php if( $offer->CHD_EXIST == '1' ): ?> checked <?php endif; ?>>
                                    <label class="custom-control-label" for="child_exist_<?php echo e($offer->OFFER_CATEGORY_ID); ?>">Has Child</label>
                                  </div>
...
<?php /* D:\Running Project\nun-14-05-19\nan\resources\views/admin/offer/offer_category_list.blade.php */ ?>